...
| ---------------- | ------------------------------------------------------------ |
| Lucida / Exam    | "Exam" em pílula azul (`#007AFF`) — opcional, uso secundário |
| Lucida Analytics | "Analytics" em pílula roxa (`#6C3CFB`)                       |
...
O símbolo (Lulu) adota a cor primária do produto em que está sendo exibido:
**azul `#007AFF`** em Lucida/Exam, **roxo `#6C3CFB`** em Lucida Analytics.
O texto "Lucida" permanece **preto** nas duas versões coloridas.

| Situação                                  | Versão a usar                    |
| ----------------------------------------- | -------------------------------- |
| Fundo claro com bom contraste             | Colorida (azul+preto OU roxo+preto, conforme produto) |
| Fundo escuro                              | Branca                           |
