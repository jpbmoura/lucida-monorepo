...
export function AnalyticsProfileMenu({ name, email, initials }: ProfileMenuProps) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="grid size-8 shrink-0 place-items-center rounded-full bg-gradient-to-br from-analytics-primary to-analytics-dark-01 text-[12px] font-semibold text-white">
          {initials}
        </span>
