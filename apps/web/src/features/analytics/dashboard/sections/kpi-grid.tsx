import { Users, UserCheck, FileText, Target, type LucideIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import type { OrgOverviewDTO } from "../data";

interface KpiGridProps {
  summary: OrgOverviewDTO["summary"];
}
  ...
  const kpis: Kpi[] = [
    {
      ...
      hint:
        summary.totalTeachers === 0
          ...
          : `de ${summary.totalTeachers} ${summary.totalTeachers === 1 ? "docente" : "docentes"}`,
      featured: true,
    },
    {
    ...
    },
    {
      ...
      value:
        summary.overallAverage !== null
          ? summary.overallAverage.toLocaleString("pt-BR", {
              minimumFractionDigits: 1,
              maximumFractionDigits: 1,
            })
          : "—",
      unit: summary.overallAverage !== null ? "/10" : undefined,
      icon: Target,
      hint:
        summary.overallAverage !== null
          ? "ponderada por volume de submissões"
